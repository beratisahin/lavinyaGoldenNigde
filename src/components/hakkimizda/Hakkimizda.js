...
function Hakkimizda() {
  useDocumentTitle("Niğde Lavinya Golden Güzellik Merkezi");
  return (
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            ...
            yüzlü ekibi ile estetik ve güzellik sektöründe Niğde’da merkezi
            ...
            kavuşuyorsunuz. Ailenizden biri olmayı amaçlayan Niğde Lavinya Golden
          ...
          <p class="hizmetyazi">
            ...
            olmak için emin adımlarla, şehrin gözdesi Niğde merkezde ileri seviye hizmet vermektedir. Kadın ve erkeklere özel
            ayrı salonlarımızda, memnuniyet ve sonuç odaklı profesyonel
            uygulamalar yapıyoruz.
          </p>

          <p class="hizmetyazi">
            Niğde Lavinya Golden Güzellik Merkezi olarak Lazer Epilasyon, G5
            Masajı, Kavitasyon, Kirpik Lifting, Yosun Peeling,
            Hydrafacial Cilt Bakımı hizmetlerimiz mevcuttur. Kampanyalarımız ve
            detaylar için sosyal medya hesaplarımızı takipte kalın. Niğde
